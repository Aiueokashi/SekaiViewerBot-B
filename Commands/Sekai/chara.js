...
class Character extends Command {
	...
	async run(message, [...args]) {
		...
		if (isNaN(args[0])) {
			...
			.setThumbnail(this.client.pjAPI.charaURL.replace('<<characterId>>',CHARACTER_ID))
			.setTitle(
			...
			.setDescription(`${transTitle.introduction} : ${transProf[CHARACTER_ID].introduction}`);
